...
class Punto2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._O_range = Range(-5, 5, 1, 0, 200)
        self._O_win = RangeWidget(self._O_range, self.set_O, "Offset", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._O_win)
        self._A_range = Range(-10, 10, 0.1, 1, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, 2*A, -A+O, 0)
    ...
    def set_O(self, O):
        self.O = O
        self.analog_sig_source_x_1.set_offset(-self.A+self.O)
    ...
    def set_A(self, A):
        self.A = A
        self.analog_sig_source_x_1.set_amplitude(2*self.A)
        self.analog_sig_source_x_1.set_offset(-self.A+self.O)
