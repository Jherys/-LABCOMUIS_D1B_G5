...
class Punto2a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demodulador FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demodulador FM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Punto2a")
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(88000000, 108000000, 100000, 88100000, 200)
        ...
        self._Ga_range = Range(0, 30, 0.5, 1, 200)
        ...
        self.uhd_usrp_source_0.set_gain(Ga, 0)
        ...
        self.qtgui_freq_sink_x_1.set_y_axis(-90, 10)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate/50, 100000, 10000, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(self.fc, self.samp_rate)
        self.qtgui_freq_sink_x_1.set_frequency_range(0, self.samp_rate/50)
    ...
    def set_Ga(self, Ga):
        self.Ga = Ga
        self.uhd_usrp_source_0.set_gain(self.Ga, 0)




def main(top_block_cls=Punto2a, options=None):
